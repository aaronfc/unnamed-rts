...
import Resource from "../entities/objects/resource.js";
import TownCenter from "../entities/buildings/town_center.js";
import Enemy from "../entities/units/enemy.js";
...
export default class MainScene extends Phaser.Scene {
  ...
  create() {
    ...
    for (var i = 0; i < INITIAL_VILLAGERS; i++) {
      this.villagers.push(
        new Villager(this, newPosition.x, newPosition.y, townCenter, null)
      );
    }
